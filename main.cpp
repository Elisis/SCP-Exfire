...
//Should focus on moving below to another file, it's getting a bit too monolithic
...
private:
	...
	QueueFamilyIndices findQueueFamilies(VkPhysicalDevice device) {
		...
		VkQueueFamilyProperties* properties = queueFamilies.data();
